...
<div class="adds">
	<form name="add" action="addmessage.php" method="post">
		<input type="text" name="name" placeholder="输入所拾物品名称"><br>
		<input type="text" name="attribute" placeholder="输入所拾物品类别"><br>
		<input type="text" name="describes" placeholder="输入所拾物品描述"><br>
		<input type="text" name="findaddress" placeholder="输入捡到地点"><br>
